...
\[
\varphi_i(\xi) = \cosh(\beta_i\xi)-\cos(\beta_i\xi) - C_i\left[\sinh(\beta_i\xi)-\sin(\beta_i\xi)\right],
\quad \xi\in[0,L],
\]
with
\[
...
\[
\lambda_1\approx 1.8751,\quad \lambda_2\approx 4.6941,\quad \lambda_3\approx 7.8548,\quad \lambda_4\approx 10.9955.
\]
...
\[
\boldsymbol{\psi}_i(x) = \begin{bmatrix}0\\ \varphi_i(x)\end{bmatrix}.
\]
...
\[
\ddot q^{n+1} = \frac{F^{n+1} - c\,\dot q_{\mathrm{pred}} - k\,q_{\mathrm{pred}}}
